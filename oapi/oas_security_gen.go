...
var operationRolesAPIKey = map[string][]string{
	...
	AddAssetsToAlbumsOperation:            []string{},
	...
	CreatePartnerDeprecatedOperation:      []string{},
	...
	DeleteAssetMetadataOperation:          []string{},
	DeleteAssetsOperation:                 []string{},
	DeleteDuplicateOperation:              []string{},
	DeleteDuplicatesOperation:             []string{},
	...
	DeletePeopleOperation:                 []string{},
	DeletePersonOperation:                 []string{},
	...
	DeleteUserOnboardingOperation:         []string{},
	...
	GetApkLinksOperation:                  []string{},
	GetAssetDuplicatesOperation:           []string{},
	GetAssetInfoOperation:                 []string{},
	GetAssetMetadataOperation:             []string{},
	GetAssetMetadataByKeyOperation:        []string{},
	GetAssetOcrOperation:                  []string{},
	...
	RemoveAssetFromStackOperation:         []string{},
	...
	SearchAssetStatisticsOperation:        []string{},
	SearchAssetsOperation:                 []string{},
	SearchLargeAssetsOperation:            []string{},
	...
	SetUserOnboardingOperation:            []string{},
	SetupPinCodeOperation:                 []string{},
	TagAssetsOperation:                    []string{},
	UnlinkAllOAuthAccountsAdminOperation:  []string{},
	...
	UpdateAssetMetadataOperation:          []string{},
